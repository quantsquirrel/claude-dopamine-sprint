...
1. WebFetch로 `https://docs.anthropic.com/en/docs/claude-code` 문서 인덱스 페이지를 가져온다.
   - 또는 `https://docs.anthropic.com/en/docs/claude-code/llms.txt`를 시도한다 (있으면 더 구조화된 데이터를 얻을 수 있음).
2. 현재 문서 페이지 목록을 추출한다 (URL + 제목).
